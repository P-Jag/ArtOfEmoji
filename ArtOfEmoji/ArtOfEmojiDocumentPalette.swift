...
extension ArtOfEmojiDocument
{
    private static let PalettesKey = "ArtOfEmojiDocument.PalettesKey"
    ...
    private(set) var paletteNames: [String:String] {
        get {
            UserDefaults.standard.object(forKey: ArtOfEmojiDocument.PalettesKey) as? [String:String] ?? [
                "😀😅😂😇🥰😉🙃😎🥳😡🤯🥶🤥😴🙄👿😷🤧🤡":"Faces",
                "🍏🍎🥒🍞🥨🥓🍔🍟🍕🍰🍿☕️":"Food",
                "🐶🐼🐵🙈🙉🙊🦆🐝🕷🐟🦓🐪🦒🦨":"Animals",
                "⚽️🏈⚾️🎾🏐🏓⛳️🥌⛷🚴‍♂️🎳🎼🎭🪂":"Activities"
        ...
        set {
            UserDefaults.standard.set(newValue, forKey: ArtOfEmojiDocument.PalettesKey)
